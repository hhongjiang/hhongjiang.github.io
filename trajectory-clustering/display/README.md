# Trajectory_Clustering_Challenge_Description
...
Cluster the provided trajectories based on their space/time (relative) similarity and detect the outlier trajectories.
