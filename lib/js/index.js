...
window.open("https://hhongjiang.github.io/blog");
});

var link2 = document.querySelector('.card-2');
link2.addEventListener('click', function() {
window.open("https://hhongjiang.github.io/color-picker");
});

var link3 = document.querySelector('.card-3');
link3.addEventListener('click', function() {
window.open("https://github.com/hhongjiang/hhongjiang.github.io");
});

var link4 = document.querySelector('.card-4');
link4.addEventListener('click', function() {
window.open("https://hhongjiang.github.io/daycycle");
});

var link5 = document.querySelector('.card-5');
link5.addEventListener('click', function() {
window.open("https://hhongjiang.github.io/txt");
});

var link6 = document.querySelector('.card-6');
link6.addEventListener('click', function() {
window.open("https://hhongjiang.github.io/fest");
});
